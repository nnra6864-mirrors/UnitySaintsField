...
namespace Editor.Playa.AnimatorEditorHijack
{
    ...
    [CustomEditor(typeof(UnityEditor.Animations.AnimatorStateMachine), true)]
    internal class SaintsStateMachineInspector: UnityEditor.Graphs.AnimationStateMachine.StateMachineInspector
    {
